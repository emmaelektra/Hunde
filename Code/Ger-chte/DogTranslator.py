...
pydub.AudioSegment.converter = r"C:\Users\limbo\anaconda3\pkgs\imageio-2.9.0-pyhd3eb1b0_0\site-packages\imageio\plugins"
...
for n in range(0,end,2):
    ...
    #stereo_audio = AudioSegment.from_file(r"C:\Users\limbo\Desktop\TAWA\Real-Time-Voice-Translator-in-Python\audioCap.mp3", format = "mp3")
